...
public class Game_Gravity 
{
	...
	public static void pVp()
	{
		...
		while (!wins)
		{
			...
			if (empty)
			{
				System.out.print("Place a chess directly. ");
			}
			else
			{
				System.out.print("Place (p) or control gravitational field (g)? ");
				mode = in.next().toUpperCase().charAt(0);
			}

			if (mode == 'G')
			{
				//Gravitational field. 
				System.out.print("What is the direction? (N/S/E/W)");
